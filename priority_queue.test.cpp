...
void TestUpdatePriorityQueue() {
  {
    ...
    ASSERT_EQUAL(queue.PeekMin().item, 199UL);
    ...
    ASSERT_EQUAL(queue.PeekMin().item, 4UL);
  ...
  }
  {
    ...
    ASSERT_EQUAL(queue.Size(), 3UL);  // (2,3),(3,2),(4,1)
    queue.Insert(199, 0);
    ASSERT_EQUAL(queue.Size(), 4UL);  // (2,3),(3,2),(4,1),(200,0.5),(199,0)
    ASSERT_EQUAL(queue.PeekMin().item, 199UL);
    ASSERT_EQUAL(queue.PeekMin().weight, 0);
    queue.Insert(200, 0.5);
    ASSERT_EQUAL(queue.Size(), 5UL);  // (2,3),(3,2),(4,1),(200,0.5),(199,0)
    ASSERT_EQUAL(queue.PeekMin().weight, 0);
    ASSERT_EQUAL(queue.PeekMin().item, 199UL);
    queue.PopMin();
    ASSERT_EQUAL(queue.Size(), 3UL);  // (2,3),(3,2),(4,1)
